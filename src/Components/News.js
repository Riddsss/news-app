...
const News = (props) => {
    ...
    const updateNews = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?in=${props.country}&category=${props.category}&apiKey=a5b42d148b934c609f259034b800e11f&page=${page}&pageSize=${props.pageSize}`
        setPage(page + 1)
        setLoading(true)
